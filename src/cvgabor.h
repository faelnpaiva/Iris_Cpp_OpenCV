...
public:
 ...
 /*1*/    CvGabor(int iMu, int iNu, double dSigma);
 /*2*/   CvGabor(int iMu, int iNu, double dSigma, double dF);
 /*3*/   CvGabor(double dPhi, int iNu);
 /*4*/  CvGabor(double dPhi, int iNu, double dSigma);
 /*5*/  CvGabor(double dPhi, int iNu, double dSigma, double dF);
